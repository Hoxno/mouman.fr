...
<section class="inline-block w-full h-full bg-primary py-24 clip-path-mypolygon" id="about">
    ...
    <div class="mx-auto my-auto max-w-5xl grid md:grid-cols-2 md:text-left md:items-center text-center">
        <div class="justify-self-center w-64 h-64 md:w-[320px] md:h-[312px] border border-white border-solid rounded-full">
            <img src="{{ str_starts_with($user->image, 'http') ? $user->image : asset('storage/' . $user->image) }}" alt="" class="md:inline-block w-64 h-64 p-1 rounded-full border-0 md:w-[320px] md:h-[310px]">
        </div>
