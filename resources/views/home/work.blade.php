...
<section class="py-8 md:pt-32 md:pb-12" id="work">
    ...
    <div class="relative ml-3.5 pl-6 pb-3.5 bd-grid">
        @foreach ($works as $work)
            <h2 class="text-secondary before:content-[' '] before:block before:absolute before:w-3.5 before:h-3.5 before:bg-secondary before:rounded-full before:left-0 before:z-1 before:top-1 after:content-[' '] after:block after:absolute after:w-1 after:h-full after:top-1 after:bg-secondary after:left-[5px]">
