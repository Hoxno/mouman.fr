...
<header class="flex w-full fixed top-0 left-0 bg-[#fff] z-50 shadow-3xl">
    ...
    tabindex="-1"
>
    <li><a href="#about" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">A propos</a></li>
    <li><a href="#skills" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Compétence</a></li>
    <li><a href="#work" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Expérience</a></li>
    <li><a href="#school" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Formation</a></li>
    <li><a href="#contact" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Contact</a></li>
    {{-- Ajoutez des liens pour d'autres sections si nécessaire --}}
</ul>
