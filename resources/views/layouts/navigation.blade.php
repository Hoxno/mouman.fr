<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed w-full">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-[#6B7280] bg-white hover:text-[#374151] focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dashboard.skill.index')" :active="request()->routeIs('dashboard.skill.index')">
                {{ __('Mes compétences') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('dashboard.work.index')" :active="request()->routeIs('dashboard.work.index')">
                {{ __('Mes expériences') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('dashboard.school.index')" :active="request()->routeIs('dashboard.school.index')">
                {{ __('Mes formations') }}
            </x-responsive-nav-link>
